...
- The architecture visual is intentionally labeled as an explanatory diagram.
  The separate application figure is a real capture of the frozen release
  binary using only a generated synthetic fixture; replace it only with another
  equivalently verified capture, never a fabricated application screenshot.
